import {fastestHalfNumbers,fastestSOE,fastestSqrt,primeBtwnStartEndHALF,primeBtwnStartEndSQRT,primeBtwnStartSEIVE} from '../logic/index.js'
...
const strategySelector = (start,end,strategy=1)=>{
    ...
    return { 
        primes, 
        timeElapsed:`${(endTime-startTime).toFixed(3)} ms`, 
